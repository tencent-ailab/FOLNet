...
step=$2
task=${3:-"CLUTRR"} # "CLUTRR"; ...
trainset="train234"
data_dir="./finetune_data/"${task}"/systgen_"${trainset}"/" # use your custom path to the finetuning data
model_dir="" # use your custom name for the model directory that stores the model checkpoints
model_file="" # use your custom name of the model checkpoint
vocab_file="./finetune_data/vocab.txt" # use your custom path to the vocabulary file
output_dir="./Experiments/FOLNet/"${model_dir}"systgen_"${trainset}"/" # use your custom path that stores the finetuned checkpoints and results
...
max_seq_length=${17:-"256"} # 256 for CLUTRR
