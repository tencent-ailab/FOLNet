...
step=$2
task=$3 # "MNLI"; ...
data_dir="./finetune_data/GLUE/"${task}"/" # use your custom data path to GLUE dataset
model_dir="" # use your directory that contains the pretrained model checkpoints
model_file="" # use your pretrained model checkpoint file name
vocab_file="./vocab.txt" # use your custom path of the vocabulary file
output_dir="./Experiments/FOLNet/"${model_dir} # use your path to store finetuned model checkpoints
pretrained_model_path="./Experiments/FOLNet/"${model_dir}${model_file}".step"${step}
max_seq_length=${17:-"128"}
